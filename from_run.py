...
def main():
    ...
    parser.add_argument('--run_path', required=True, help='path to the run file generated by Anserini(qid Q0 did rank score run_tag)')
    ...
    get_content_from_run_ids(args.run_path, col, args.data_path, args.anserini_path, args.index_path, args.use_doc_title, args.topic_field, args.K)
